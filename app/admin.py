...
class MessageAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ("created", "formatted_embedding")
 
    fieldsets = (
        (
            "Message",
            {
                "fields": ("session", "role", "text", "created"),
            },
        ),
        (
            "Embedding",
            {
                ...
                "description": "Vector embedding of the message text.",
            },
        ),
    )
    ...
    def formatted_embedding(self, obj):
        """
        Pretty‑printed JSON representation of the message embedding.
        """
